        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              “Encontré al equipo ideal para mi proyecto de diseño gráfico en
              muy poco tiempo. La plataforma facilitó todo el proceso, desde la
              publicación de la oferta hasta la entrega final. ¡Excelente
              experiencia!”
            </p>
          </div>
          ...
          <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              “Como freelancer, esta plataforma me ha permitido conectar con
              empresas que realmente valoran mi trabajo. La gestión de proyectos
              es muy intuitiva y me permite concentrarme en lo importante.”
            </p>
          </div>
          ...
          <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              “Lo que más me gusta es la transparencia en los procesos. Puedo
              ver claramente los detalles del proyecto, gestionar tiempos y
              mantener comunicación fluida con los freelancers. Totalmente
              recomendable.”
            </p>
          </div>
          ...
          <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              “He logrado colaborar en proyectos internacionales gracias a esta
              plataforma. Me encanta lo fácil que es mostrar mi portafolio y
          ...
          <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              “Publicar proyectos nunca fue tan sencillo. En pocos días encontré
              profesionales que se ajustaron a mis necesidades, y el seguimiento
              del progreso fue impecable.”
            </p>
          </div>
          ...
          <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              “Gracias a esta página he podido mantener un flujo constante de
              trabajo como programador independiente. Me siento respaldado en
              cada etapa del proyecto, desde el acuerdo hasta el pago.”
            </p>
          </div>
        </div>
      </div>
