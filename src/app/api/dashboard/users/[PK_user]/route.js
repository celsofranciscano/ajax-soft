...
// Validar parámetro dinamico PK_user
...
// Metodo get para usuario especifico
...
// metodo put para actualizar un usuario de forma completa
...
// emtodo PATCH: Actualizar parcialmente un usuario
export async function PATCH(request, { params }) {
  try {
    ...
    // validacion de datos de forma flexible
    const validation = validateRequestBody(body, {
      FK_role: { type: "number" },
